// #define SUBCRIBER_PICO
// should add micro_ros_raspberrypi_pico_sdk, pico-example andpico-sdk
#ifdef SUBCRIBER_PICO
...
int main() {
  ...
  rclc_executor_add_subscription(&executor, &subscription, &msg,
