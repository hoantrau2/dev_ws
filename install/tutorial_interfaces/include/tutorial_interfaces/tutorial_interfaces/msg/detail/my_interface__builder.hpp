...
class Init_MyInterface_size
{
public:
  explicit Init_MyInterface_size(::tutorial_interfaces::msg::MyInterface & msg)
  : msg_(msg)
  {}
  ::tutorial_interfaces::msg::MyInterface size(::tutorial_interfaces::msg::MyInterface::_size_type arg)
  {
...
{
public:
  Init_MyInterface_data()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MyInterface_size data(::tutorial_interfaces::msg::MyInterface::_data_type arg)
  {
    msg_.data = std::move(arg);
    return Init_MyInterface_size(msg_);
  }
...
{
  return tutorial_interfaces::msg::builder::Init_MyInterface_data();
}
