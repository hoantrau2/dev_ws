...
bool tutorial_interfaces__msg__float64__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._float64.Float64", full_classname_dest, 40) == 0);
  }
  tutorial_interfaces__msg__Float64 * ros_message = _ros_message;
  {  // data
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * tutorial_interfaces__msg__float64__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Float64 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._float64");
  ...
  tutorial_interfaces__msg__Float64 * ros_message = (tutorial_interfaces__msg__Float64 *)raw_ros_message;
  {  // data
    PyObject * field = NULL;
